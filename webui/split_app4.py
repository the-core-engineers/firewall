...
files = {
    "src/pages/Rules.jsx": """import React, { useState } from 'react';
...
export default function RulesPage() {
  ...
  const handleAddRule = async (e) => {
    ...
    const payload = {
      ...
      src_ip: newRule.src_ip || null,
      dst_ip: newRule.dst_ip || null,
      src_port: newRule.src_port ? parseInt(newRule.src_port) : null,
